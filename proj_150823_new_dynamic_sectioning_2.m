...
for i = 1:sectionsCount
    ...
    audioSample = inAudio(audioIndex);
    
    %TODO: windowing.
    audioSample = audioSample .* hamming(sampleLength);
    
    fftAbsResult = abs(fft(audioSample));
    ...
    %% find Peaks in FFT       
    fftTreshold =  5.0; % 6.3 fft thesholding
...
%     windowArray
    ...
    filterInputIndexStart = startAudioIndex - paddingLength;
    filterInputIndexEnd = endAudioIndex+ postPaddingLength;
    ...
    outputBoundary= [ outputBoundary; [startAudioIndex,startAudioIndex+filterOutputLength-1]];
