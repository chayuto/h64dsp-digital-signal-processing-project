function [outAudio] = fn_151126_OverlapProcessing(inAudio,...
...
for i = 1:sections
    ...
    [windowArray] = fn_151126_freqWinFromFFT(fftArray(i,:),frequencyIndex,fs,2.2);
    
    [outAudioSection,filterDestinationIndex] = fn_151126_FIR_filter_window(inAudio,fs,sectionBoundary,windowArray,2000); %500
