...
for i = 1:sectionsCount
    ...
    [windowArray] = fn_151030_fftBasedFreqWindows(filteredLow,fs,sectionBoundary,3.5);
...
for i = 1:sectionsCount
    ...
    [windowArray] = fn_151030_fftBasedFreqWindows(filteredHigh,fs,sectionBoundary,3.5);%2.0  %3.5

    [outAudioSection,filterDestinationIndex] = fn_151106_FIR_filter_window(filteredHigh,fs,sectionBoundary,windowArray,2000);
