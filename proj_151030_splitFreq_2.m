...
for i = 1:40
    [V,I] = min(A);
    if I > spacing && I < (125-spacing)
        A(I-spacing:I+spacing) = 1000;
        B(I) = i*10;
...
for i = 1:trackCount
    ...
    for j = 1:sectionsCount
        ...
        [windowArray] = fn_151029_fftBasedFreqWindows(track,fs,sectionBoundary,8);
...
errorAudio2 = cleanAudio - filteredSumOut ;
sound([filteredSumOut;cleanAudio])
