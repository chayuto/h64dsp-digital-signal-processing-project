...
outAudio = fn_151126_OverlapProcessing(inAudio,refAudio,fs,0,hWB);
refOutAudio = fn_151126_OverlapProcessing(refAudio,refAudio,fs,0,hWB);

delta1Audio = inAudio - outAudio;

temp1Audio = outAudio;
outAudio = fn_151126_OverlapProcessing(outAudio,refOutAudio,fs,0,hWB);
...
tempAudio = outAudio;
outAudio = fn_151125_SP_DS_FX_4(tempAudio,tempAudio,fs,hWB);
