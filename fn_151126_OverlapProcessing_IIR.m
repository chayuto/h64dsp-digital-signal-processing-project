function [outAudio] = fn_151126_OverlapProcessing_IIR(inAudio,...
...
for i = 1:sections
    ...
    [outAudioSection,filterDestinationIndex] = fn_151126_IIR_filter_window(inAudio,fs,sectionBoundary,windowArray,2000); %500
