...
for i = 1:sectionsCount
    ...
    [windowArray] = fn_151029_fftBasedFreqWindows(filteredLow,fs,sectionBoundary,3.0);

    [outAudioSection,filterDestinationIndex] = fn_151029_FIR_filter(filteredLow,fs,sectionBoundary,windowArray,2000);
...
for i = 1:sectionsCount
    ...
    [windowArray] = fn_151029_fftBasedFreqWindows(filteredHigh,fs,sectionBoundary,4.3);

    [outAudioSection,filterDestinationIndex] = fn_151029_FIR_filter(filteredHigh,fs,sectionBoundary,windowArray,2000);
