function [mixedOut] =  fn_151130_SP_DS_FX_4(inAudio,refAudio,fs,hWB)

%proj_151026_fn_Split_2CH(inAudio,fs,tresholdFreq)
[filteredLow,filteredHigh] =  fn_151130_Split_2CH(inAudio,fs,325); %325 Hz
[refFilteredLow,refFilteredHigh] =  fn_151130_Split_2CH(refAudio,fs,325); %325 Hz
...
for i = 1:sectionsCount
    ...
    [outAudioSection,filterDestinationIndex] = fn_151125_FIR_filter_window(filteredLow,fs,sectionBoundary,windowArray,2000);
