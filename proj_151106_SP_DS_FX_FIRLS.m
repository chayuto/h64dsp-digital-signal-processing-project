...
waitbar(0,hWB,' fn_151029_Split_2CH');
...
for i = 1:sectionsCount
    ...
    [outAudioSection,filterDestinationIndex] = fn_151106_FIRLS(filteredLow,fs,sectionBoundary,windowArray,2000);
...
for i = 1:sectionsCount
    ...
    [outAudioSection,filterDestinationIndex] = fn_151106_FIRLS(filteredHigh,fs,sectionBoundary,windowArray,1500);
