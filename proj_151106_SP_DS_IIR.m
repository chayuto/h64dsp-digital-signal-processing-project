...
for i = 1:sectionsCount
    ...
    [outAudioSection,filterDestinationIndex] = fn_151106_IIR(filteredLow,fs,sectionBoundary,windowArray,20);
...
%     outAudioSections(i,1:length(filterDestinationIndex)) = outAudio(filterDestinationIndex);
     ...
     waitbar(i/sectionsCount,hWB,sprintf('Filtering Low Section %d...',i ));
end
...
for i = 1:sectionsCount
    ...
    [windowArray] = fn_151030_fftBasedFreqWindows(filteredHigh,fs,sectionBoundary,3.5);

    [outAudioSection,filterDestinationIndex] = fn_151106_IIR(filteredHigh,fs,sectionBoundary,windowArray,20);
...
%     outAudioSections(i,1:length(filterDestinationIndex)) = outAudio(filterDestinationIndex);
    ...
    waitbar(i/sectionsCount,hWB,sprintf('Filtering High Section %d...',i ));
end
