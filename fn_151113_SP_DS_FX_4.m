function [mixedOut] =  fn_151113_SP_DS_FX_4(inAudio,refAudio,fs,hWB)
...
for i = 1:sectionsCount
    ...
    [windowArray] = fn_151111_fftBasedFreqWindows_Hm(refFilteredLow,fs,sectionBoundary,4);

    [outAudioSection,filterDestinationIndex] = fn_151113_FIR_filter_window_2(filteredLow,fs,sectionBoundary,windowArray,2000);
...
for i = 1:sectionsCount
    ...
    [outAudioSection,filterDestinationIndex] = fn_151113_FIR_filter_window_2(filteredHigh,fs,sectionBoundary,windowArray,2800);
