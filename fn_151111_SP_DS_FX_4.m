function [mixedOut] =  fn_151111_SP_DS_FX_4(inAudio,fs,hWB)
...
for i = 1:sectionsCount
    ...
    [windowArray] = fn_151111_fftBasedFreqWindows_Hm(filteredLow,fs,sectionBoundary,4);
...
for i = 1:sectionsCount
    ...
    [windowArray] = fn_151111_fftBasedFreqWindows_Hm(filteredHigh,fs,sectionBoundary,3.5);%2.0  %3.5
