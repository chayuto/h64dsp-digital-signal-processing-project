...
for i = 1:sectionsCount
    ...
    %waitbar(iBlkNo/iTotalBlk,hWB,sprintf('Matching... Shift:%d, Frame:%d/%d, Blk:%d/%d ',Nshift,m,StopFrame,iBlkNo,iTotalBlk));
     waitbar(i/sectionsCount,hWB,sprintf('Filtering Section %d...',i ));
...
for i = 1:sectionsCount
    ...
    [outAudioSection,filterDestinationIndex] = fn_151029_FIR_filter(filteredHigh,fs,sectionBoundary,windowArray,1500);
