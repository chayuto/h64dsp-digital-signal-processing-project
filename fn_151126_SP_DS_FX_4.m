function [mixedOut] =  fn_151126_SP_DS_FX_4(inAudio,refAudio,fs,hWB)
...
for i = 1:sectionsCount
    ...
    [windowArray] = fn_151126_fftBasedFreqWindows_Hm(refFilteredLow,fs,sectionBoundary,3.5);

    [outAudioSection,filterDestinationIndex] = fn_151126_FIR_filter_window(filteredLow,fs,sectionBoundary,windowArray,2000);
...
for i = 1:sectionsCount
    ...
    [windowArray] = fn_151126_fftBasedFreqWindows_Hm(refFilteredHigh,fs,sectionBoundary,3.5);%2.0  %3.5

    [outAudioSection,filterDestinationIndex] = fn_151126_FIR_filter_window(filteredHigh,fs,sectionBoundary,windowArray,2000);
